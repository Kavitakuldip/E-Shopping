...
<!-- Mirrored from themesbrand.com/skote/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 14:35:42 GMT -->
<head>
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{asset('index.html')}}" key="t-default">Default</a></li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                     <li><a href="{{url ('Admin/Categoris/Index')}}" key="t-tui-calendar">AddCategory</a></li>
                                    
                                    <li><a href="{{url ('/brandindex')}}" key="t-full-calendar">Add Brand</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="/productindex" >AddProduct</a></li>
                                    <li><a href="/product/color/index" >Product Color</a></li>
                                   
                               </ul>
                            </li>

                            <li>
                                <a href="{{asset('apps-filemanager.html')}}" class="waves-effect">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{asset('ecommerce-products.html')}}" key="t-products">Products</a></li>
                                </ul>
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{asset('auth-login.html')}}" key="t-login">Login</a></li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="{{asset('pages-starter.html')}}" key="t-starter-page">Starter Page</a></li>
...
<!-- Mirrored from themesbrand.com/skote/layouts/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 06 Sep 2024 14:36:23 GMT -->
</html>